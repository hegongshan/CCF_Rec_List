...
let ARCH_PDC_SS = {
    ...
    "journals/tcad": {
        "venue": "TCAD",
        "fullname": "IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems",
        "rank": "A"
    },
    "journals/tc": {
        "venue": "TC",
    ...
    "journals/tcasI": {
        "venue": "TCASI",
        "fullname": "IEEE Transactions on Circuits and Systems I: Regular Papers",
        "rank": "C"
    },
    "journals/ccfthpc": {
        "venue": "CCF-THPC",
        "fullname": "CCF Transactions on High Performance Computing",
        "rank": "C"
    },
    "journals/tsusc": {
        "venue": "TSUSC",
    ...
    "conf/ipps": {
        "venue": "IPDPS",
        "fullname": "IEEE International Parallel & Distributed Processing Symposium",
        "rank": "B"
    },
    "conf/performance": {
        "venue": "Performance",
    ...
    "conf/mascots": {
        "venue": "MASCOTS",
        "fullname": "International Symposium on Modeling, Analysis, and Simulation of Computer and Telecommunication Systems",
        "rank": "C"
    },
    "conf/ispa": {
        "venue": "ISPA",
    ...
    "conf/hoti": {
        "venue": "HOTI",
        "fullname": "IEEE Symposium on High-Performance Interconnects",
        "rank": "C"
    },
    "conf/vts": {
        "venue": "VTS",
...
let CN = {
    ...
    "journals/wicomm": {
        "venue": "WCMC",
        "fullname": "Wireless Communications and Mobile Computing",
        "rank": "C"
    },
    "journals/winet": {
    ...
    "conf/iwqos": {
        "venue": "IWQoS",
        "fullname": "IEEE/ACM International Workshop on Quality of Service",
        "rank": "B"
    },
    "conf/imc": {
        "venue": "IMC",
    ...
    "conf/ancs": {
        "venue": "ANCS",
        "fullname": "ACM/IEEE Symposium on Architectures for Networking and Communication Systems",
        "rank": "C"
    },
    "conf/apnoms": {
        "venue": "APNOMS",
...
let NIS = {
    ...
    "journals/imcs": {
        "venue": "IMCS",
        "fullname": "Information and Computer Security",
        "rank": "C"
    },
    "journals/ijics": {
        "venue": "IJICS",
    ...
    "conf/esorics": {
        "venue": "ESORICS",
        "fullname": "European Symposium on Research in Computer Securit",
        "rank": "B"
    },
    "conf/fse": {
        "venue": "FSE",
...
let SE_SS_PL = {
    ...
    "journals/tsc": {
        "venue": "TSC",
        "fullname": "IEEE Transactions on Services Computing",
        "rank": "A"
    },
    ...
    "journals/sosym": {
        "venue": "SoSyM",
        "fullname": "Software and Systems Modeling",
        "rank": "B"
    },
    "journals/stvr": {
        "venue": "STVR",
    ...
    "journals/sttt": {
        "venue": "STTT",
        "fullname": "International Journal of Software Tools for Technology Transfer",
        "rank": "C"
    },
    "journals/jlap": {
        "venue": "JLAMP",
        "fullname": "Journal of Logical and Algebraic Methods in Programming",
        "rank": "C"
    },
    "journals/jwe": {
        "venue": "JWE",
    ...
    "conf/sigsoft": {
        "venue": "FSE",
        "fullname": "ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering",
        "rank": "A"
    },
    "conf/sosp": {
        "venue": "SOSP",
    ...
    "conf/lctrts": {
        "venue": "LCTES",
        "fullname": "ACM SIGPLAN/SIGBED International Conference on Languages, Compilers and Tools for Embedded Systems",
        "rank": "B"
    },
    "conf/models": {
        "venue": "MoDELS",
    ...
    "conf/spin": {
        "venue": "SPIN",
        "fullname": "International Symposium on Model Checking of Software",
        "rank": "C"
    },
    "conf/atva": {
        "venue": "ATVA",
    ...
    "conf/tase": {
        "venue": "TASE",
        "fullname": "Theoretical Aspects of Software Engineering Conference",
        "rank": "C"
    },
    "conf/msr": {
        "venue": "MSR",
...
let CST = {
    ...
    "journals/jsyml": {
        "venue": "JSL",
        "fullname": "The Journal of Symbolic Logic",
        "rank": "C"
    },
    "journals/lmcs": {
        "venue": "LMCS",
    ...
    "conf/setta": {
        "venue": "SETTA",
        "fullname": "International Symposium on Dependable Software Engineering: Theories, Tools, and Applications",
        "rank": "C"
    },
};
...
let CG_MM = {
    ...
    "journals/jvca": {
        "venue": "CAVW",
        "fullname": "computer animation & virtual worlds",
        "rank": "C"
    },
    "journals/cg": {
        "venue": "C&G",
    ...
    "conf/siggraph": {
        "venue": "SIGGRAPH",
        "fullname": "ACM Special Interest Group on Computer Graphics",
        "rank": "A"
    },
    "conf/vr": {
        "venue": "VR",
...
let AI = {
    ...
    "conf/cvpr": {
        "venue": "CVPR",
        "fullname": "IEEE/CVF Computer Vision and Pattern Recognition Conference",
        "rank": "A"
    },
    "conf/iccv": {
        "venue": "ICCV",
...
let INTERDISCIPLINARY_EMERGING = {
    ...
    "journals/jbi": {
        "venue": "JBI",
        "fullname": "Journal of Biomedical Informatics",
        "rank": "C"
    },
    "journals/mia": {
    ...
    "conf/sagt": {
        "venue": "SAGT",
        "fullname": "International Symposium on Algorithmic Game Theory",
        "rank": "C"
    },
    "conf/sigspatial": {
        "venue": "SIGSPATIAL",
        "fullname": "ACM Special Interest Group on Spatial Information",
        "rank": "C"
    },
    "conf/icic": {
        "venue": "ICIC",
